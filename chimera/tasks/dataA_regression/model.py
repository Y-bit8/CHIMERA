...
#        self.bn2 = BN(6*hidden+1*num_patterns*num_patterns+76+3+1024)
        ...
        self.lin3 = Linear((2048)//4+16*hidden//4+6*num_patterns*num_patterns//4, 1)
...
#            val_loader = DataLoader(val_dataset, batch_size=batch_size)
            ...
            for l in layers:
                for h in hidden:
                    ...
                    domain_dmm = Discriminator(input_size=2048+16*h+6*10*10,output_size=2048+16*h+6*10*10, n_class=2)
