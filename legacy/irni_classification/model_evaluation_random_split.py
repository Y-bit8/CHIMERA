...
#            self.convs3.append(TransformerConv(1*hidden, hidden, 1, edge_dim=dataset[0][0].num_edge_features))
        ...
        self.bn1 = BN(2048+16*hidden+6*num_patterns*num_patterns+7)
#        self.bn2 = BN(6*hidden+1*num_patterns*num_patterns+76+3+1024)
        #self.bn3 = BN(16*hidden)
        
        
        self.lin1 = Linear(2048+16*hidden+6*num_patterns*num_patterns+7, (2048)//2+16*hidden//2+6*num_patterns*num_patterns//2+7)
        self.lin2 = Linear((2048)//2+16*hidden//2+6*num_patterns*num_patterns//2+7, (2048)//4+16*hidden//4+6*num_patterns*num_patterns//4+7)
        self.lin3 = Linear((2048)//4+16*hidden//4+6*num_patterns*num_patterns//4+7, 2)
...
#        self.lin7 = Linear(2048, 2048//8)
        ...
        self.lin8 = Linear(2048+16*hidden+6*num_patterns*num_patterns+7, 2048+16*hidden+6*num_patterns*num_patterns+7)
...
#            val_loader = DataLoader(val_dataset, batch_size=batch_size)
            ...
            for l in layers:
                for h in hidden:
                    ...
                    domain_dmm = Discriminator(input_size=2*(2048+16*h+6*10*10+7),output_size=2*(2048+16*h+6*10*10+7), n_class=2)
